  ...
  return (
    <section className={classes.projects}>
      <div className={classes.content}>
        ...
        <h2>Description</h2>
        <p>
          A distinctive dice game crafted using React for the frontend and Node.js for the backend.
          It offers an enjoyable experience where players roll a dice, aiming for numbers 3, 6, or 5
          to win, and any other number results in a loss. The implementation is seamless, with React
          employed to create an engaging single-page application that enhances the overall gaming
          experience.
        </p>
      </div>
      <div className={classes.content}>
      ...
      <div className={classes.content}>
        ...
        <p>
          ...
          transferring funds within the bank and to international banks. It's important to note that
          this is a dummy bank and not valid for actual transactions. It serves the purpose of
          showcasing my skills and the services I offer, developed using the JavaScript MERN stack.
        </p>
      </div>
      <div className={classes.content}>
        <div className={classes.photo}>
