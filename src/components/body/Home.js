  ...
  return (
    <Fragment>
      ...
      <section className={classes.hero}>
        ...
        <p>
          My journey is driven by a fascination with the evolving landscape of technology. I thrive
          on turning this fascination into tailored solutions for start-ups and individuals aiming
          to elevate their presence through captivating websites. My commitment lies in crafting
